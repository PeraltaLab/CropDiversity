...
ggsave("../figures/16SrRNA_BCC_RplotFINAL.pdf", plot=last_plot(), device=NULL, path=NULL, scale=1, width=NA, height=NA, dpi=300, limitsize=TRUE)
```
...
ggsave("../figures/PHLD_RplotFINAL.pdf", plot=last_plot(), device=NULL, path=NULL, scale=1, width=NA, height=NA, dpi=300, limitsize=TRUE)
```
