...
# PostHoc Test DOESNT WORK YET "error: Error in shannon$stats : $ operator is invalid for atomic vectors"
  tuk <- HSD.test(aov(BD.DIVsoilmicrobes$shannon ~ treatments), "treatments")
  grp <- HSD.shannon$groups[c(match(levels(treatments), gsub(" ", "", HSD.shannon$groups$trt))), ]
